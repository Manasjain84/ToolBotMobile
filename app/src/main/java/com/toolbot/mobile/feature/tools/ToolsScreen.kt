...
private val toolItems = listOf(
    ...
    ToolItem("Image Resizer", ToolCategory.IMAGE_CAMERA, Icons.Outlined.Percent),
    ToolItem("Image Format Converter", ToolCategory.IMAGE_CAMERA, Icons.Outlined.Transform),
